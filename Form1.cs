...
namespace bchunkGUIWin
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            openBinButton.Click += new EventHandler(this.ClickOpenBinButton);
            ...
            openCueButton.Click += new EventHandler(this.ClickOpenCueButton);
            ...
            convertButton.Click += new EventHandler(this.ClickConvertButton);
        ...
        private void OpenDialog(string ext)
        {
            ...
            {
                fileDialog.InitialDirectory = Environment.GetEnvironmentVariable("USERPROFILE");
        ...
        private void RunBchunk()
        {
            ...
            startInfo.Arguments = $"\"{binPath}\" \"{cuePath}\" \"{binPath.Substring(0, binPath.Length - 4)}\"";
